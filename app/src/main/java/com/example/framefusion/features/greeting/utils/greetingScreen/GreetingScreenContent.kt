package com.example.framefusion.features.greeting.utils.greetingScreen
...
@Composable
fun GreetingScreenContent(navigator: Navigator) {
    Column(
        modifier = Modifier
            .fillMaxSize(),
        ...
        Column(
            ...
            OutlinedButton(
                onClick = { navigator.navigateToOnboarding() },
                modifier = Modifier
                    .fillMaxWidth()
